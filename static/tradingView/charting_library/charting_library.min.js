...
function(t) {
    ...
    function(t) {
        ...
        i = 1,
        n = arguments.length; i < n; i++) for (var s in e = o[i]) Object.prototype.hasOwnProperty.call(e, s) && (t[s] = e[s]);
        return t
    };
    function o(t, i) {
        var n = e({},
        t);
        for (var s in i)"object" != typeof t[s] || null === t[s] || Array.isArray(t[s]) ? void 0 !== i[s] && (n[s] = i[s]) : n[s] = o(t[s], i[s]);
        return n
    }
    var i = {
        mobile: {
    ...
    function s() {
        return "1.14 (internal id 1fc9a873 @ 2019-10-18 15:13:20.429807)"
    }
    var r = function() {
        function t(t) {
        ...
        t.prototype._create = function() {
            ...
            var i = this._iFrame; (this._options.autosize || this._options.fullscreen) && (i.style.width = "100%", this._options.fullscreen || (i.style.height = "100%")),
